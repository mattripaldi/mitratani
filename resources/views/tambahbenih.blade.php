            ...
            <div class="card-body">
                <form method="POST" action="{{route('stokbenih.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="harga_beli_sak" name="harga_beli_sak" />
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Harga Jual</label>
                        <input type="number" class="form-control" id="harga_jual_sak" name="harga_jual_sak" />
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Harga Jual/Kg</label>
                        <input type="number" class="form-control" id="harga_jual_kg" name="harga_jual_kg" />
                    </div>
