                ...
                <div class="card-body">
                    <form method="POST" action="{{route('varietas.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_varietas') is-invalid @enderror" id="nama_varietas" name="nama_varietas" value="{{ old('nama_varietas') }}" required />
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Deskripsi Varietas</label>
                            <input type="text" class="form-control @error('deskripsi_varietas') is-invalid @enderror" id="deskripsi_varietas" name="deskripsi_varietas" value="{{ old('deskripsi_varietas') }}" />
                        </div>
                        <div class="form-group">
