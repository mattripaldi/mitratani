                    ...
                    <tbody class="text-center">
                        @foreach($hasils as $hasil)
                            <tr>
                                ...
                                <td><a href="{{ url('admin/detailfasevegetatif/'.$hasil->id) }}" class="btn btn-warning btn-sm">Detail</a></td>
                                <td><a href="{{ url('admin/detailfaseberbunga/'.$hasil->id) }}" class="btn btn-warning btn-sm">Detail</a></td>
                                <td><a href="{{ url('admin/detailfasemasak/'.$hasil->id) }}" class="btn btn-warning btn-sm">Detail</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
