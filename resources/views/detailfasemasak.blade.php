    ...
    <div class="col-md-12">
        <div class="card mb-2">
            <div class="card-header text-center">
                <strong>DETAIL HASIL MONITORING FASE MASAK</strong>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="foto text-center mt-3">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="13">
                                        <a href="{{url('/admin/cetak/masak/'.$hasil->pemeriksaan_awal_id)}}" class="btn btn-success btn-sm float-right"> <i class="fas fa-print"></i> Cetak</a>
                                    </td>
                                </tr>
                                @endif @else
                                <tr>
